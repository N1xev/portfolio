...
export const welcomeText = `<svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 650 140">
  <text class="font-code" fill="currentColor" style="font-size: 10px; white-space: pre;">
  ...
  <text x="0" y="115" class="font-mono" fill="currentColor" style="font-size: 14px;">Welcome, user. Type 'help' to see available commands.</text>
</svg>`;
