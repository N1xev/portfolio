  ...
  <section id="projects" class="flex flex-col w-full overflow-hidden ">
    ...
    >
      ...
      <div class="max-w-4xl mx-auto text-center relative z-10">
        ...
        <h2
            class="text-5xl md:text-7xl font-bold font-accent mb-8 tracking-tight"
        >
          Selected
          <span
              class="underline decoration-dashed decoration-gray-400 dark:decoration-gray-600 underline-offset-8"
          >Projects</span
          >
        </h2>
          <UiTextScramble
      ...
      >
        <template #default="{ item: project }">
          <div class="border-r border-dashed border-gray-300 dark:border-gray-700 h-[450px] px-0">
            ...
            >
              <div
                  class="aspect-video w-full relative overflow-hidden border-b border-dashed border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 pointer-events-none flex-shrink-0"
              >
                <div
              ...
              <div class="p-6 flex-1 flex flex-col min-h-0">
                  ...
                  <div class="flex justify-between items-start mb-2">
                    ...
                    <UTooltip v-if="project.links.demo" text="Live Preview">
                      <UButton
                          ...
                          class="p-0 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0"
                          size="xs"
                          target="_blank"
                          variant="link"
                      >
                ...
                <p
                    class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-6 line-clamp-3 flex-shrink-0"
                >
                  {{ project.description }}
                </p>
