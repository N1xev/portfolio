    ...
    <UHeader
      ...
      <template #right>
        ...
        <UTooltip :kbds="['meta', 'G']" text="Open on GitHub">
          <UButton aria-label="GitHub" color="neutral" icon="i-simple-icons-github" target="_blank"
            to="https://github.com/N1xev/portfolio" variant="ghost" />
        </UTooltip>
      </template>

      <template #body>
        <UNavigationMenu :items="items" class="-mx-2.5 rounded-none" orientation="vertical" />
      </template>
    </UHeader>
  </div>
</template>
