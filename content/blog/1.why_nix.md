...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6 items-stretch">
<div class="flex">

::callout{color="warning" icon="i-lucide-fingerprint" class="w-full flex-1 !m-0 flex flex-row items-center"}
**Input A:** `git-source` + `openssl-3.0`  
**Result:** `...nawl092-git`
::
</div>
<div class="flex">

::callout{color="success" icon="i-lucide-fingerprint" class="w-full flex-1 !m-0 flex flex-row items-center"}
**Input B:** `git-source` + `openssl-3.1`  
**Result:** `...x8dhcf2-git`
::
</div>
</div>
